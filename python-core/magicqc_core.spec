...
a = Analysis(
    ['core_main.py'],
    pathex=['D:\\RJM\\operatorPannel-main\\python-core'],
    binaries=[('D:\\RJM\\operatorPannel-main\\python-core\\integration.cp313-win_amd64.pyd', '.'), ('D:\\RJM\\operatorPannel-main\\python-core\\measurement_worker.cp313-win_amd64.pyd', '.'), ('D:\\RJM\\operatorPannel-main\\python-core\\worker_logger.cp313-win_amd64.pyd', '.')],
    datas=[],
